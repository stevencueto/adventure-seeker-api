"""
Django settings for adventureseeker_api project.
...
load_dotenv()
BDS_PWD = str(os.environ.get("DBS_PWD"))
...
ALLOWED_HOSTS = ['adventureseekerapi.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'adventureseeker_api.urls'
...
WSGI_APPLICATION = 'adventureseeker_api.wsgi.application'
